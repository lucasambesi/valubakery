...
namespace ValuBakery.Percistence.Migrations
{
    ...
    [Migration("20250617215757_refactor-recipe-to-recipevariant")]
    partial class refactorrecipetorecipevariant
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ValuBakery.Data.Entities.RecipeComponent", b =>
                {
                    b.HasOne("ValuBakery.Data.Entities.RecipeVariant", "ChildRecipe")
                        .WithMany("UsedIn")
                        .HasForeignKey("ChildRecipeVariantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ValuBakery.Data.Entities.RecipeVariant", "ParentRecipe")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("ValuBakery.Data.Entities.RecipeIngredient", b =>
                {
                    ...
                    b.HasOne("ValuBakery.Data.Entities.RecipeVariant", "Recipe")
